\begin{frame}{Der Dampfmaschinen-EBook-Reader}
		\pgfimage[width=.7\textwidth]{bilder/1935-ebook-sm} \\
		Skizze aus "`Science and mechanics"' (1935)
\end{frame}

\begin{frame}{Dynabook}
	\begin{columns}
		\column{.5\textwidth}
		...
		\column{.5\textwidth}
			\begin{itemize}
				...
				\item Technische Dokumentation Panzer
				\item Gilt auch als Erfindung des Laptops
			\end{itemize}
	\end{columns}
\end{frame}
...
\begin{frame}{Rise of the E-Book}
	\begin{columns}
		\column{.5\textwidth}
			\begin{itemize}
				\item 1998: "`Rocket eBook"' -- 5,5\dq LCD-Screen, 620\,g, 499\,\$
				\item 2000: Mobipocket vertreibt Readersoftware (Palm, Windows CE, etc.)
				\item 2002: Randomhouse und HarperCollins verkaufen digitale Versionen ihrer Bücher
			\end{itemize}
		\column{.5\textwidth}
...
\begin{frame}{Rise of the E-Book}
	\begin{itemize}
		\item 2005: Amazon kauft Mobipocket
		\item 2006: Sony PRS-500 -- 6\dq eInk-Display, 250\,g, 350\,\$
		\item ab 2007: iPhone und Android -- Readersoftware
		\item 2007: Amazon Kindle
		\item<2-> 2010: Apple iPad
		\item<2-> Q2/2010: Amazon verkauft mehr E-Books als Hardcovers
		\item<2-> Q2/2011: ...mehr E-Books als gedruckte Bücher
	\end{itemize}
\end{frame}
